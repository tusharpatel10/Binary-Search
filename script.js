...
for (var i = 0; i < blocks.length; i += 1) {
	blocks[i].style.backgroundColor = "#303030";
}
...
while (start <= end) {
	...
	blocks[mid].style.backgroundColor = "#cccccc";
	...
	blocks[mid].style.backgroundColor = "#fe8040";
	flag = 1;
	break;
	}
	...
	blocks[mid].style.backgroundColor = "#303030";
	} else {
	start = mid + 1;
	blocks[mid].style.backgroundColor = "#303030";
	}
